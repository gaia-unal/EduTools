    ...
    <section class="principal">
        <div class="options">
            ...
            <table class="table table-hover table-striped">
                <thead>
                    <tr>
                        <th rowspan="2" class="ct-h ct-v">id</th>
                        <th rowspan="2" class="ct-h ct-v">Cuestionario</th>
                        <th rowspan="2" class="ct-h ct-v">Ver</th>
                        <th colspan="2" class="ct-h">Exportar</th>
                        <th rowspan="2" class="ct-h ct-v">Eliminar</th>
                    </tr>
                    <tr>
                        <th class="ct-h">HTML</th>  
                        <th class="ct-h">SCORM</th>  
                    </tr>
                </thead>
                <tbody>
                @foreach($preguntas as $questionario)
                    <tr>
                        ...
                        <td class="ct-h"><a href="{{route("Question.cuestionario",$questionario->id)}}"><i class="glyphicon glyphicon-eye-open"></i></a>
                        </td>
                        <td class="ct-h">
                            <a href="{{route("Question.exportQuest",$questionario->id)}}"><i class=" glyphicon glyphicon-export"></i></a>
                        </td>
                        <td class="ct-h">
                            <a href="{{route("Question.exportQuestSCORM",$questionario->id)}}"><i class=" glyphicon glyphicon-export"></i></a>
                        </td>
                        <td class="ct-h">
